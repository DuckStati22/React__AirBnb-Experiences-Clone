...
function Card(props) {
  ...
  return (
    <div className="card">
      ...
      <img className="card__image" src={require(`../img/${props.coverImg}`)} alt="Katie Zaferes" />
      <div className="card__rating">
        ...
        <div className="grey-text">({props.stats.reviewCount}) • </div><span></span>
        <div className="grey-text">{props.location}</div>
      </div>
      <p className="card__title">{props.title}</p>
      <p className="card__price"><span className="card__para_bold">From ${props.price}</span> / person</p>
    </div>
  )
}
